      ...
      <>
            ...
            <div className="bg-white rounded-lg max-w-xs w-full p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link
                  ...
                  className="flex items-center justify-center gap-2 border border-gray-300 rounded-lg p-3 hover:bg-gray-50 transition"
                >
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 pt-2" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom))' }}>
          <div className="flex items-center justify-around h-16">
            <Link
              href="/dashboard"
              className={`flex flex-col items-center justify-center gap-1 flex-1 py-2 ${pathname === "/dashboard" ? "text-blue-500" : "text-gray-600"}`}
            >
            ...
            <button
              ...
              className="flex flex-col items-center justify-center gap-1 flex-1 py-2 text-blue-500"
            >
            ...
            <Link
              href="/expenses"
              className={`flex flex-col items-center justify-center gap-1 flex-1 py-2 ${pathname === "/expenses" ? "text-blue-500" : "text-gray-600"}`}
            >
            ...
            <Link
              href="/incomes"
              className={`flex flex-col items-center justify-center gap-1 flex-1 py-2 ${pathname === "/incomes" ? "text-blue-500" : "text-gray-600"}`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 flex-1 py-2 text-gray-600`}
            >
        ...
        {menuOpen && (
          <div className="fixed top-16 right-4 z-40 bg-white rounded-lg shadow-lg border border-gray-200">
            <button
              ...
              className="flex items-center gap-2 w-full px-4 py-2 text-gray-700 hover:bg-gray-100 text-sm font-medium"
            >
